...
import { Flex, Text, Image, Button, Link } from 'rebass'
import VerifySuccess from 'image/verify-success.svg'
import VerifyFailed from 'image/verify-failed.svg'
import RightArrowSrc from 'image/icon-right-arrow.svg'
import OutLinkSrc from 'image/out.svg'
